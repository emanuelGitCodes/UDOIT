...
restart-ace:
		docker compose -f docker-compose.nginx.yml stop ace
		docker compose -f docker-compose.nginx.yml rm -f ace
		docker compose -f docker-compose.nginx.yml up -d ace
